  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-white flex items-center justify-center">
        <div className="text-green-600">Loading dashboard...</div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-white p-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-green-900 mb-2">Admin Dashboard</h1>
          <p className="text-green-700">Manage property visit bookings and track performance</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="border-green-200">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-green-800">Cancelled</CardTitle>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          <div className="flex gap-2 flex-wrap">
            <Button
              ...
              className={selectedStatus === "all" ? "bg-green-600 hover:bg-green-700" : "border-green-200 text-green-700 hover:bg-green-50"}
            >
              All ({stats.total})
            </Button>
            <Button
        ...
        <Card className="border-green-200">
          <CardHeader>
            <CardTitle className="text-green-900">Property Visit Bookings</CardTitle>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-green-200">
                    <th className="text-left py-3 px-4 font-medium text-green-800">Name</th>
                    <th className="text-left py-3 px-4 font-medium text-green-800">Contact</th>
                    <th className="text-left py-3 px-4 font-medium text-green-800">BHK Type</th>
                    <th className="text-left py-3 px-4 font-medium text-green-800">Status</th>
                    <th className="text-left py-3 px-4 font-medium text-green-800">Date</th>
                    <th className="text-left py-3 px-4 font-medium text-green-800">Actions</th>
                  </tr>
                </thead>
                <tbody>
                  {filteredBookings.map((booking: Booking) => (
                    <tr key={booking.id} className="border-b border-green-100 hover:bg-green-50">
                      <td className="py-3 px-4 text-green-900">{booking.name}</td>
                      <td className="py-3 px-4 text-green-700">{booking.contact_number}</td>
                      <td className="py-3 px-4 text-green-700">{booking.bhk_type || 'N/A'}</td>
