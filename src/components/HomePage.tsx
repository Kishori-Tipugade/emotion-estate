...
export const HomePage = () => {
  ...
  const features = [
    { icon: MapPin, title: "Prime Location", description: "Strategically located in Sector 18, Noida with excellent connectivity" },
    { icon: Home, title: "Modern Design", description: "Contemporary architecture with premium finishes and spacious layouts" },
