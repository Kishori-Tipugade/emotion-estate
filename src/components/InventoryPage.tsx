...
export const InventoryPage = ({ isAdminLoggedIn = false }: InventoryPageProps) => {
  ...
  const views = [
    { id: "exterior", name: "3D Exterior View", icon: Building },
    { id: "interior", name: "Interior View", icon: Eye },
    { id: "parking", name: "Parking View", icon: Car },
  ...
  const handleRotateView = () => {
    ...
    toast({
      title: "Rotating View",
      description: "3D view is rotating...",
    });
    ...
    <div className="flex items-center justify-center w-full h-full">
      <Building className="w-24 h-24 text-blue-600" />
        ...
        <Card className="shadow-xl border-blue-100">
          <CardHeader>
            <CardTitle className="text-3xl font-bold text-blue-900 text-center">3D Property Simulation</CardTitle>
